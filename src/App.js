...
function App() {
  ...
  return (
    <Provider store={store}>
      <Helmet>
        <title>Peace Accord</title>
        <meta
        name="description"
        content="An application for developing a peace agreement between citizens of the world. The goal is to establish a platform for capturing the largest amount of signatures to the agreement."
        />
        <meta
        name="keywords" content="Peace, Agreement, Sign, Accord"
        />
      </Helmet>
      <div className="App">
